      ...
      <Grid container spacing={3}>
        <Grid item xs={3}>
          ...
          >
            ...
            <Paper sx={{ margin: '0 10% 10px 10%' }} className='paper'>
        ...
        <Grid item xs={12} sm container spacing={2}>
          <Grid item xs={6}>
            <Paper variant="outlined" sx={{ height: '90%' }} className='paper'>
          ...
          <Grid item xs={6}>
            <Paper variant="outlined" className='paper'>Personality</Paper>
          </Grid>
          <Grid item xs={6}>
            <Paper variant="outlined" className='paper'>Bio2</Paper>
          </Grid>
          <Grid item xs={6}>
            <Paper variant="outlined" className='paper'>Goals</Paper>
          </Grid>
          <Grid item xs={6}>
            <Paper variant="outlined" className='paper'>Worked for this brands</Paper>
          </Grid>
        </Grid>
      </Grid >
    </>
